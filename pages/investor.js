...
import Header2 from '../components/Layout/components/Header2/Header2'
import InvestorRelations from '../components/Layout/components/InvestorRelations/InvestorRelations'
    ...
    <header id="header" className="fixed-top ">
        ...
        <a href="/" className="logo mr-auto"><img src="assets/img/logo3.jpg" alt="" className="img-fluid"/></a>
          ...
          <nav id="nav-menu" className="nav-menu d-none d-lg-flex">
            <ul>
              <li><a href="/">Home</a></li>
              <li className="active"><a href="/investor">Investor Relations</a></li>
