...
import Header4 from '../components/Layout/components/Header4/Header4'
import CompanyDisclosures from '../components/Layout/components/CompanyDisclosures/CompanyDisclosures'
import Footer from '../components/Layout/components/Footer/Footer'


export default function CompanyDisclosures1() {
  return (
    <>
        ...
        <a href="/" className="logo mr-auto"><img src="assets/img/logo3.jpg" alt="" className="img-fluid"/></a>
          ...
          <nav id="nav-menu" className="nav-menu d-none d-lg-flex">
            <ul>
              ...
              <li className="drop-down"><a href="/regulardirectors">Meet the team</a>
                <ul>
                  ...
                  <li><a href="/executiveofficers">Executive Officers</a></li>
                </ul>
              </li>
    
              <li className="drop-down active"><a href="/downloadables">Downloadables</a>
                <ul>
                  ...
                  <li className="drop-down active"><a href="/companydisclosures">Company Disclosures</a>
                    <ul>
