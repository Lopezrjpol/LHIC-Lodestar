...
import IndependentDirectors from '../components/Layout/components/IndependentDirectors/IndependentDirectors'
import CTA from '../components/Layout/components/CTA/CTA'
import Footer from '../components/Layout/components/Footer/Footer'


export default function IndependentDirectors1() {
  return (
    <>
          ...
          <nav id="nav-menu" className="nav-menu d-none d-lg-flex">
            <ul>
              ...
              <li className="drop-down active"><a href="/regulardirectors">Meet the Team</a>
                <ul>
                  <li className="drop-down active"><a href="/regulardirectors">Board of Directors</a>
                    <ul>
                      <li><a href="/regulardirectors">Regular Directors</a></li>
                      <li className="active"><a href="/independentdirectors">Independent Directors</a></li>
                    </ul>
                  </li>
